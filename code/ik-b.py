...
obstacle_radius = 0.2 # Original

# obstacle_radius = 0.4 #Changed

# initial state (in configuration space)
q0 = np.array([0, 0, 1.86]) # Original

# q0 = np.array([1.5, 0.5 , 1.86]) #Changed
...
def constraint1(x):
    ...
    p2 = fk(x[:1],link_lengths)
    constraint = - line_sphere_intersection(origin,p2,obstacle_center,obstacle_radius)
...
def constraint2(x):
    ...
    """
    # FILL in your code here
    p1 = fk(x[:1] ,link_lengths)
    p2 = fk(x[:2] ,link_lengths)
    constraint = - line_sphere_intersection(p1,p2,obstacle_center,obstacle_radius)
...
def constraint3(x):
    ...
    """
    # FILL in your code here
    p1 = fk(x[:2] ,link_lengths)
    p2 = fk(x[:3],link_lengths)
    constraint = - line_sphere_intersection(p1,p2,obstacle_center,obstacle_radius)
